...
MONGO_CATEGORY_COLLECTION = f"{PROJECT_NAME}_category_uids"
MONGO_PLP_COLLECTION = f"{PROJECT_NAME}_products"
MONGO_PDP_COLLECTION = f"{PROJECT_NAME}_products_detailed"
